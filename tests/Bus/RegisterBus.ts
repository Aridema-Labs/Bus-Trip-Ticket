...
describe("Register a Bus Line", () => {
  ...
  it("Is initialized!", async () => {
    ...
    console.log("----------------------------------------------")
    console.log("0 to 3 km ticket price:", Account.to3km)
    console.log("----------------------------------------------")
    console.log("3 to 6 km:", Account.to6km)
    console.log("----------------------------------------------")
    console.log("6 to 12 km ticket price:", Account.to12km)
    console.log("----------------------------------------------")
    console.log("12 to 27 km ticket price:", Account.to27km)
    console.log("----------------------------------------------")
    console.log("more 27 kmticket price:", Account.more27km)
    console.log("----------------------------------------------")
  });
});